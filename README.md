...
| <a name="input_greenplum_version"></a> [greenplum\_version](#input\_greenplum\_version) | The version of Greenplum to deploy. Supported: 6.28 (6.25 is no longer supported by the API). | `string` | `"6.28"` | no |
